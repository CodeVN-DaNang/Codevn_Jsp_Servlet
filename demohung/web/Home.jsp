    ...
    <head>
        ...
        <style>
            ...
            .carousel-item:nth-child(1) {
                background-image: url('https://d1csarkz8obe9u.cloudfront.net/posterpreviews/furniture-offer-banner-template-design-68ad4bf3efb2eecb66fa4ed92949e755_screen.jpg?ts=1678701643');
            ...
            .carousel-item:nth-child(2) {
                background-image: url('https://as2.ftcdn.net/v2/jpg/05/08/17/01/1000_F_508170187_4Oonk4IG8u9eyfwSUvTASkT8hl71vRX2.jpg');
                background-repeat: no-repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
            ...
            .carousel-item:nth-child(3) {
                background-image: url('https://as2.ftcdn.net/v2/jpg/03/37/85/75/1000_F_337857599_HHFoUl39WpoTLDbPLGlm0mURFlB81Cy8.jpg');
                background-repeat: no-repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
    ...
    <body class="skin-light" onload="loadAmountCart()">
        <jsp:include page="Menu.jsp"></jsp:include>
            ...
            <div class="card-group" style="margin-top:50px;">
                <div class="card" style="border-style: none;">
                    <img style="height:55px; width:64px; margin: auto;" src="https://umea.qodeinteractive.com/wp-content/uploads/2021/04/icon-2.png">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://umea.qodeinteractive.com/wp-content/uploads/2020/12/subscribe-img.png" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://umea.qodeinteractive.com/wp-content/uploads/2021/04/icon-7.png" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://umea.qodeinteractive.com/wp-content/uploads/2021/04/icon-1.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="row" style="margin-top:25px">            
                <h1 style="text-align:center; width:100%" id="nike">NỘI THẤT PHÒNG NGỦ</h1>
                <div class="col-sm-12">
            ...
            <div class="row" style="margin-top:25px">            
                <h1 style="text-align:center; width:100%" id="adidas">NỘI THẤT GỖ</h1>
                <div class="col-sm-12">
                                    ...
                                    <div id="content" class="row">
                                        <div class=" col-12 col-md-12 col-lg-6">
                                                <div class="card-body">
                                                    ...
                                                    <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">GROUP6</h2>
        ...
        <script>
                        ...
                        function loadAmountCart() {
                            $.ajax({
                                url: "/demohung/loadAllAmountCart",
                                type: "get", //send it through get method
                                data: {
