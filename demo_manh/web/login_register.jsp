<%-- 
    ...
    Created on : Mar 10, 2024, 11:07:33 AM
    Author     : miulan
--%>
    ...
    <body>
        <div class="login-box">
            ...
            <form method="post" action="signup" class="email-signup" id="signup-form">
                ...
                <div class="form-group">
                    <input name="user_dob" id="form3Example4cg" class="form-control form-control-lg" placeholder="Date of Birth"/>
                </div>
                <div class="form-group">
                    <input  name="user_website"  id="form3Example3cg" class="form-control form-control-lg" placeholder="website"/>
                </div>
                <div class="form-group">
                    <input name="user_country" type="text" id="form3Example4cg" class="form-control form-control-lg" placeholder="country"/>
                </div>
               
                <div class="form-group">
                    <input name="user_gender" type="text" id="form3Example4cg" class="form-control form-control-lg" placeholder="Gender"/>
                </div>
                <div class="form-group">
                ...
                <a class="nav-link" style="color: blue;" href="http://localhost:8080/demo_manh/home">Home</a>
            </form>
        </div>
            ...
            window.onload = function () {
                ...
                form.addEventListener("submit", function (event) {
                    ...
                    if (response) {
                        ...
                        error.innerHTML = "Please check reCAPTCHA before you sign up!";
                    }
                });
            }
        </script>
