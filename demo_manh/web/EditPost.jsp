                            ...
                            <div class="col-lg-6">
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <img src="${post_img}" height="auto" width="50%" alt="alt"/> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <input id="post_title" name="post_title" class="form-control pin-creator-input mb-3" rows="3" placeholder="Post Title..." aria-label="Description" value="${post_title}"></input>
                                <textarea id ="post_description" name="post_description" class="form-control pin-creator-input mb-3" rows="3" placeholder="Post Description..." aria-label="Description" value="${post_description}"></textarea>
                                <textarea id="post_tag" name="post_tag" class="form-control pin-creator-input mb-3" rows="3" placeholder="Post Tag..." aria-label="Description" value="${post_tag}"></textarea>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-danger btn-block pin-creator-button">Save Pin</button>
                </form>
            </div>
        </div>
